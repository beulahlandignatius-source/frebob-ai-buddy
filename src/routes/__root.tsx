...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI business assistant for Nigerian SMEs: track orders, customers, inventory, and payments with multilingual voice in English, Pidgin, Yoruba, Hausa, and Igbo." },
      { name: "author", content: "FreBob" },
      { name: "robots", content: "index,follow" },
      { name: "referrer", content: "strict-origin-when-cross-origin" },
      { property: "og:title", content: "FreBob — Your Smart Business Assistant" },
      { property: "og:description", content: "AI-powered assistant for Nigerian SMEs. Orders, payments, inventory, customers — with multilingual voice." },
